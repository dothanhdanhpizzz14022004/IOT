...
String mainPage()
{
  ...
  <head>
    ...
    <style>
      ...
      .logo { width: 220px; height: 90px; border-radius: 20px; box-shadow: 0 4px 10px rgba(0,0,0,0.2); margin-bottom: 25px; }
      .container {
      ...
      .sensor { font-size: 1.1em; margin: 12px 0; }
      .sensor span { font-weight: bold; color: #00ffcc; }
      button {
        margin: 10px 5px;
        background: #00ffcc;
        color: #000;
      ...
      #settings { background: #f2f3f5; color: #007bff; }
    </style>
  </head>
  <body>
    ...
    <div class="container">
      ...
      <div class="sensor">🌡️ Nhiệt độ: <span id="temp">)rawliteral" + String(temperature,1) + R"rawliteral(</span> °C</div>
      <div class="sensor">💧 Độ ẩm: <span id="hum">)rawliteral" + String(humidity,1) + R"rawliteral(</span> %</div>
